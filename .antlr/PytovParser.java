...
public class PytovParser extends Parser {
	...
	public static final int
		...
		RULE_string = 10, RULE_comparator = 11, RULE_binary = 12, RULE_operator = 13, 
		RULE_boolTF = 14, RULE_ifStatement = 15, RULE_identifierList = 16, RULE_declaration = 17, 
		RULE_declarationList = 18, RULE_variableDeclaration = 19, RULE_expList = 20, 
		RULE_parameterList = 21, RULE_parameterInputList = 22, RULE_whileStatement = 23, 
	...
	public final ParseContext parse() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__2) | (1L << T__7) | (1L << T__8) | (1L << T__10) | (1L << T__11) | (1L << T__12) | (1L << STRING) | (1L << NOT) | (1L << TRUE) | (1L << FALSE) | (1L << LPAREN) | (1L << RETURN) | (1L << DECIMAL) | (1L << IDENTIFIER) | (1L << SEMI_COLON) | (1L << NEWLINE))) != 0) );
			setState(69);
			match(EOF);
			}
		}
	...
	public static class SeperatorsContext extends ParserRuleContext {
		...
		public TerminalNode NEWLINE() { return getToken(PytovParser.NEWLINE, 0); }
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(93);
					((OpCpBnExpressionContext)_localctx).right = exp(5);
					}
					} 
				}
				setState(99);
	...
	public final ListrContext listr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << STRING) | (1L << NOT) | (1L << TRUE) | (1L << FALSE) | (1L << LPAREN) | (1L << DECIMAL) | (1L << IDENTIFIER))) != 0)) {
				{
				setState(108);
	...
	public final OpCpBnContext opCpBn() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_opCpBn);
		try {
			setState(116);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final NotlContext notl() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_notl);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(118);
	...
	private ParameterInputListContext parameterInputList(int _p) throws RecognitionException {
		...
		int _startState = 44;
		enterRecursionRule(_localctx, 44, RULE_parameterInputList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ReturnpContext returnp() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_returnp);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(246);
	...
	public final OpenCurlyContext openCurly() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_openCurly);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(265);
	...
	public final CloseCurlyContext closeCurly() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_closeCurly);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(267);
	...
	public static final String _serializedATN =
		...
		"\16\3\16\3\17\3\17\3\20\3\20\3\21\3\21\3\21\3\21\3\21\3\21\3\21\3\21\7"+
		...
		"\u00d0\13\27\3\30\3\30\3\30\5\30\u00d5\n\30\3\30\3\30\3\30\7\30\u00da"+
		"\n\30\f\30\16\30\u00dd\13\30\3\31\3\31\3\31\3\31\3\32\3\32\3\32\3\32\3"+
		"\32\3\32\3\33\3\33\3\33\3\33\5\33\u00ed\n\33\3\33\3\33\3\33\3\34\3\34"+
		...
		"\3\2\2\2*\u00b9\3\2\2\2,\u00c7\3\2\2\2.\u00d4\3\2\2\2\60\u00de\3\2\2\2"+
		"\62\u00e2\3\2\2\2\64\u00e8\3\2\2\2\66\u00f1\3\2\2\28\u00f8\3\2\2\2:\u0100"+
		...
		"\2\u008a\u008b\5<\37\2\u008b\u0092\3\2\2\2\u008c\u008d\7\6\2\2\u008d\u008e"+
		"\5\b\5\2\u008e\u008f\5<\37\2\u008f\u0091\3\2\2\2\u0090\u008c\3\2\2\2\u0091"+
		"\u0094\3\2\2\2\u0092\u0090\3\2\2\2\u0092\u0093\3\2\2\2\u0